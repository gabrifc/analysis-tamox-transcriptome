...
replotGSEA <- function(path, gene.set, class.name, metric.range,
  ...
  dev.copy2pdf(file = paste0(gene.set,'.pdf'), out.type = "pdf")
  # Reset to default
  par(def.par)
}
...
geneSets <- c("GO_FATTY_ACID_BETA_OXIDATION", "GO_DNA_REPLICATION_INITIATION", "GO_ANTIGEN_PROCESSING_AND_PRESENTATION", "GO_RIBOSOMAL_SUBUNIT", "GO_HOMOLOGOUS_CHROMOSOME_SEGREGATION", "GO_ELECTRON_CARRIER_ACTIVITY", "GO_STRUCTURAL_CONSTITUENT_OF_RIBOSOME", "GO_MACROMOLECULAR_COMPLEX_DISASSEMBLY", "GO_TRICARBOXYLIC_ACID_METABOLIC_PROCESS", "GO_RECOMBINATIONAL_REPAIR", "GO_ANTIGEN_PROCESSING_AND_PRESENTATION_OF_PEPTIDE_ANTIGEN_VIA_MHC_CLASS_I", "GO_FATTY_ACID_CATABOLIC_PROCESS", "GO_CHROMOSOMAL_REGION", "GO_CELL_DIVISION", "GO_REGULATION_OF_CELLULAR_AMINE_METABOLIC_PROCESS", "GO_NUCLEOSIDE_TRIPHOSPHATE_METABOLIC_PROCESS", "GO_REGULATION_OF_RNA_STABILITY", "GO_LIPID_OXIDATION", "GO_NAD_BINDING", "GO_COFACTOR_BINDING", "GO_MICROTUBULE_ASSOCIATED_COMPLEX", "GO_PROTEASOME_ACCESSORY_COMPLEX", "GO_MICROTUBULE", "GO_OXIDOREDUCTASE_ACTIVITY_ACTING_ON_NAD_P_H", "GO_FATTY_ACID_BETA_OXIDATION_USING_ACYL_COA_DEHYDROGENASE", "GO_GLYCOSYL_COMPOUND_METABOLIC_PROCESS", "GO_SYNAPSIS", "GO_MEIOSIS_I", "GO_PROTEIN_DNA_COMPLEX_SUBUNIT_ORGANIZATION", "GO_SISTER_CHROMATID_SEGREGATION", "GO_POSITIVE_REGULATION_OF_PROTEIN_MODIFICATION_BY_SMALL_PROTEIN_CONJUGATION_OR_REMOVAL", "GO_2_OXOGLUTARATE_METABOLIC_PROCESS", "GO_SYNAPTONEMAL_COMPLEX", "GO_POTASSIUM_CHANNEL_COMPLEX", "GO_DNA_REPLICATION_INDEPENDENT_NUCLEOSOME_ORGANIZATION", "GO_MITOTIC_RECOMBINATION", "GO_CELL_CYCLE_PHASE_TRANSITION", "GO_DNA_PACKAGING_COMPLEX", "GO_SPINDLE", "GO_INNATE_IMMUNE_RESPONSE_ACTIVATING_CELL_SURFACE_RECEPTOR_SIGNALING_PATHWAY", "GO_MITOTIC_SISTER_CHROMATID_SEGREGATION", "GO_MONOCARBOXYLIC_ACID_CATABOLIC_PROCESS", "GO_DICARBOXYLIC_ACID_METABOLIC_PROCESS", "GO_POTASSIUM_CHANNEL_ACTIVITY", "GO_ORGANELLE_FISSION", "GO_REGULATION_OF_RHODOPSIN_MEDIATED_SIGNALING_PATHWAY", "GO_RECIPROCAL_DNA_RECOMBINATION", "GO_ESTABLISHMENT_OF_PROTEIN_LOCALIZATION_TO_ENDOPLASMIC_RETICULUM", "GO_CYCLIC_NUCLEOTIDE_BINDING", "GO_HISTONE_KINASE_ACTIVITY")

for (geneSet in geneSets) {
  replotGSEA(path = "TAM_uninfected_vs_DMSO_uninfected_C5.GseaPreranked.1554294503199",
             gene.set = geneSet,
             class.name = 'Tamoxifen')
}


# replotGSEA(path = "TAM_uninfected_vs_DMSO_uninfected_C2.GseaPreranked.1554283730877",
#            gene.set = 'KEGG_LYSOSOME',
#            class.name = 'Tamoxifen')
